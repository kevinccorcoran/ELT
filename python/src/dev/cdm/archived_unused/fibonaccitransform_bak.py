...
def process_stock_data(df, years_to_add=3):
    ...
    # Include the original minimum dates DataFrame
...
if __name__ == "__main__":
    ...
    new_table_name = 'fibonacci_data'  # Table to save processed data
    ...
    if connection_string is None:
        ...
        try:
            ...
            if df is not None:
                ...
                # Save the filtered DataFrame to the specified table in the 'cdm' schema
