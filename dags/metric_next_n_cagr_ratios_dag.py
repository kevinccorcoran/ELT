...
def get_dbt_bash_command(env: str) -> Tuple[str, Dict[str, str]]:
    ...
    if env == "heroku_postgres":
        ...
        bash_command = (
            ...
            "/app/.heroku/python/bin/dbt run --profiles-dir /app/.dbt --project-dir /app/dbt/src/app --models next_n_cagr_ratios"
        )
        ...
        bash_command = (
            ...
            '/Users/kevin/.pyenv/shims/dbt run --models next_n_cagr_ratios || true'
        )
