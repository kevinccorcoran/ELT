...
def get_bash_command(env: str, db_connection_string: str) -> Tuple[str, Dict[str, str]]:
    ...
    if env == "heroku_postgres":
        bash_command = (
            ...
            f'/app/.heroku/python/bin/python3 /app/python/src/dev/cdm/lookup_since_ipo.py '
        ...
        bash_command = (
            ...
            '/Users/kevin/.pyenv/shims/python3 /Users/kevin/repos/ELT_private/python/src/dev/cdm/lookup_since_ipo.py '
...
# Define the DAG
dag = DAG(
    dag_id="cdm_lookup_since_ipo",
    default_args=default_args,
    description="DAG to run a Python script that updates cdm.lookup_since_ipo",
...
create_cdm_lookup_since_ipo_table = BashOperator(
    task_id='create_cdm_lookup_since_ipo_table',
...
create_cdm_lookup_since_ipo_table >> cdm_company_cagr_model
