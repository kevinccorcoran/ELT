...
def get_bash_command(env: str, db_connection_string: str) -> Tuple[str, Dict[str, str]]:
    ...
    if env == "heroku_postgres":
        bash_command = (
            ...
            f'/app/.heroku/python/bin/python3 /app/python/src/dev/cdm/lookup_dividend_start.py '
        ...
        bash_command = (
            ...
            '/Users/kevin/.pyenv/shims/python3 /Users/kevin/repos/ELT_private/python/src/dev/cdm/lookup_dividend_start.py '
...
# Define the DAG
dag = DAG(
    dag_id="cdm_lookup_dividend_start",
    default_args=default_args,
    description="DAG to run a Python script that updates cdm_lookup_dividend_start",
...
create_cdm_lookup_dividend_start = BashOperator(
    task_id='cdm_lookup_dividend_start',
...
create_cdm_lookup_dividend_start 
